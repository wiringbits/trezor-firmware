...
class TestMsgSigntposContract(TrezorTest):

    def test_sign_stakenet_0(self):
        self.setup_mnemonic_nopin_nopassphrase()
        sig = btc.sign_tpos_contract(
            self.client, "Stakenet", [0], "8aa2b43bb74ca579c08da494763aa8c0d87a6727893a6c7b88ee2e56e3b1c1f6:0"
        )
    ...
    def test_sign_stakenet_1(self):
        self.setup_mnemonic_nopin_nopassphrase()
        sig = btc.sign_tpos_contract(
            self.client, "Stakenet", [1], "483bdb594fe347052cb56c60000fba593ef7dee8bf3f069e616fbdf8353e38ae:0"
        )
    ...
    def test_sign_stakenet_2(self):
        self.setup_mnemonic_nopin_nopassphrase()
        sig = btc.sign_tpos_contract(
            self.client, "Stakenet", [2], "483bdb594fe347052cb56c60000fba593ef7dee8bf3f069e616fbdf8353e38ae:99"
        )
